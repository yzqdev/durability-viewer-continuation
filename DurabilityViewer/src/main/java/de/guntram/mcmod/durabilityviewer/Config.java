...
public class Config {
    ...
    private static final ModConfigSpec.EnumValue<HudPosition> HUD_POSITION = BUILDER
            ...
            .defineEnum("hudPosition", HudPosition.BOTTOM_RIGHT);
    ...
    private static final ModConfigSpec.IntValue SOUND_BELOW_DURABILITY = BUILDER
            ...
            .defineInRange("soundBelowDurability", 20, 0, 1500);
    private static final ModConfigSpec.IntValue SOUND_BELOW_PERCENT = BUILDER
            .comment("play sound when percent is lower than this")
            .defineInRange("soundBelowPercent", 10, 0, 100);
